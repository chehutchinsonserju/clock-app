package com.example.timerinterface.Util
...
import com.example.timerinterface.AppConstants
import com.example.timerinterface.MainActivity
import com.example.timerinterface.R
import com.example.timerinterface.TimerNotificationReceiver
    ...
    companion object {
        ...
        fun showTimerExpired(context: Context) {
            ...
            nBuilder.setContentTitle("Timer Expired!")
                ...
                .addAction(R.drawable.ic__play_arrow, "Start", startPendingIntent)
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long) {
            ...
            nBuilder.setContentTitle("Timer is Running.")
                ...
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.ic__stop, "Stop", stopPendingIntent)
        ...
        fun showTimerPaused(context: Context) {
            ...
            nBuilder.setContentTitle("Timer is paused.")
                ...
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.ic__play_arrow, "Resume", resumePendingIntent)
